...
//             <h1 className="text-2xl font-bold mb-6">새 데이터 함수 추가</h1>

//             <form action={createDataFunction} className="space-y-6">
//                 <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                     <label className="flex flex-col gap-1">
//                         <span className="text-sm font-medium">Slug *</span>
//                         <input name="slug" required placeholder="unique-slug"
//                         className="border rounded-md px-3 py-2 bg-white dark:bg-slate-900" />
//                     </label>
//                     <label className="flex flex-col gap-1">
//                         <span className="text-sm font-medium">Title *</span>
//                         <input name="title" required placeholder="Card title"
//                         className="border rounded-md px-3 py-2 bg-white dark:bg-slate-900" />
//                     </label>
//                     <label className="md:col-span-2 flex flex-col gap-1">
//                         <span className="text-sm font-medium">Description</span>
//                         <textarea name="description" rows={3} placeholder="설명"
//                         className="border rounded-md px-3 py-2 bg-white dark:bg-slate-900" />
//                     </label>
//                 </section>
...
//                     </label>
//                     <label className="flex flex-col gap-1">
//                         <span className="text-sm font-medium">Path (내부)</span>
//                         <input name="path" placeholder="/data/my-slug"
//                         className="border rounded-md px-3 py-2 bg-white dark:bg-slate-900" />
//                         <span className="text-xs text-gray-500">미입력 시 /data/:slug 적용</span>
//                     </label>
//                     <label className="flex flex-col gap-1">
//                         <span className="text-sm font-medium">External URL (외부)</span>
//                         <input name="external_url" placeholder="https://example.com"
//                         className="border rounded-md px-3 py-2 bg-white dark:bg-slate-900" />
//                     </label>
//                 </section>
...
//                     </label>
//                     <label className="flex flex-col gap-1">
//                         <span className="text-sm font-medium">Tag tone</span>
...
//                         <textarea name="metadata" rows={4} placeholder='{"key":"value"}'
//                         className="border rounded-md px-3 py-2 bg-white dark:bg-slate-900" />
//                     </label>
//                 </section>
...
import NewDataFunctionPage from "@/components/data-functions/new/NewDataFunctionPage"

export default function NewDataFunction({ params }: { params: { locale: "ko" | "en" } }) {

    return <NewDataFunctionPage locale={params.locale} />
}